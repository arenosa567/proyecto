...
function home(){
  rsync -av /home /home/paco/Documentos/web/git/proyecto/uf1466/backups/
}
#archivos y aplicaciones publicados en el servidor http
function servidorapache(){
    #apache
   rsync -av /var/www /home/paco/Documentos/web/git/proyecto/uf1466/backups/
}
function servidornode(){
    ...
    rsync -av /usr/local/bin/ /home/paco/Documentos/web/git/proyecto/uf1466/backups/node/bin/
    rsync -av /usr/local/lib/node_modules /home/paco/Documentos/web/git/proyecto/uf1466/backups/node/lib/
} 

function basedatos(){
    cd /home/paco/Documentos/web/git/proyecto/uf1466/basedato/
    #wordpress
