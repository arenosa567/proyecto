        ...
        ?>
         ...
         <form class="form" method="post">
              ...
              <div class="form-group">
				  ...
				  <input type="text" class="form-control" name="editorial" placeholder="editorial" value="<?php 
                      if(isset($_POST["update"])){
              ...
              <div class="form-group">
				 <label for="fecha">Fecha </label>
				  <input type="date" class="form-control" name="fecha" placeholder="fecha (yyyy-mm-dd)"
